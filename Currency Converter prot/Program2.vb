Public Class Program2
    Private Sub USD_CheckedChanged(sender As Object, e As EventArgs) Handles chcUSD.CheckedChanged
        ...
        USD = Amount * 0.78
        Change.Text = USD
        ' USD is Amount multiplied by 0.78 as that is the exchange rate.
    ...
    Private Sub EUR_CheckedChanged(sender As Object, e As EventArgs) Handles chcEUR.CheckedChanged
        ...
        EUR = Amount * 0.86
        Change.Text = EUR
        ' EUR is Amount multiplied by 0.86 as that is the exchange rate.
    ...
    Private Sub CNY_CheckedChanged(sender As Object, e As EventArgs) Handles chcCNY.CheckedChanged
        ...
        CNY = Amount * 0.11
        Change.Text = CNY
        ' CNY is Amount multiplied by 1.206 as that is the exchange rate.
    ...
    Private Sub COP_CheckedChanged(sender As Object, e As EventArgs) Handles chcCOP.CheckedChanged
        ...
        COP = Amount * 0.0002
        Change.Text = COP
        ' COP is Amount multiplied by 1.206 as that is the exchange rate.
    ...
    Private Sub NGN_CheckedChanged(sender As Object, e As EventArgs) Handles chcCOP.CheckedChanged
        Dim Amount As Decimal
        Dim NGN As Decimal
        ' Declares "Amount" and "NGN" as a decimal because they will be digits.
        ...
        NGN = Amount * 0.00081
        Change.Text = NGN
        ' NGN is Amount multiplied by 1.206 as that is the exchange rate.
        ' Changes the text to NGN.
        ...
        If chcCOP.Checked Then
            ...
            lstTransactions.Items.Add(text2add)
        End If
        ' If the NGN checkbox is checked then it will declare "text2add" as a string.
        ' "text2add" will add the idividual text "GBP-- " and the amount of GBP entered and then the individual text " - NGN-- " and the amount of NGN exchanged from GBP.
        ' That is then added to the ListBox "lstTransactions.
    End Sub
